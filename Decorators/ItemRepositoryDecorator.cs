...
namespace Gelato.Decorators
{
    public sealed class ItemRepositoryDecorator : IItemRepository
    {
        ...
        private readonly ILogger<ItemRepositoryDecorator> _log;
        public ItemRepositoryDecorator(
                      ILogger<ItemRepositoryDecorator> log,
...
private void ApplyAlternateFilter(InternalItemsQuery filter)
{
    ...
    var ctx = _http?.HttpContext;
     _log.LogDebug($"apply alternate filter for: {ctx?.Request.GetDisplayUrl()}");
